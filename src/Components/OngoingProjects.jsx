                    ...
                    >
                        <div className="flex items-center justify-between flex-col h-full relative overflow-hidden font-[Montserrat]">
                            ...
                            >
                                ...
                                <div className="mx-5 my-2 hover:cursor-pointer" onClick={()=>{setVisible(true)}}>
                        ...
                        `}
                            >
                                ...
                                >
                                    Veenus Infra’s Sri Sai Sarada offers 3 BHK
                                    Vasthu-compliant apartments (1700-1800 sq.
                                    ft.) in a prime location near Madavadara.
                                    These 3-floor towers feature no common
                                    walls, cellar parking, 24/7 security, power backup, and
                                    ensuring comfort,
                                    ventilation, and a peaceful lifestyle.
                                    <span><br/><span className="font-bold">Location:</span> near Varma Complex, Muralinagar, Madavadara.</span>
                                </p>
                            </div>
                        </div>
                    </div>
